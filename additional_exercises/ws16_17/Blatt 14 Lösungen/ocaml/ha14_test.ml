...
let () =
  add 20 @@ Test.make_simple_test ~title:"test_simple" test_simple;
  add 50 @@ Test.make_simple_test ~title:"test_multi_register_status_sync" test_multi_register_status_sync;
  add 70 @@ Test.make_simple_test ~title:"test_multi_all_sync" test_multi_all_sync;
  add 60 @@ Test.make_simple_test ~title:"test_multi_all_async" test_multi_all_async
