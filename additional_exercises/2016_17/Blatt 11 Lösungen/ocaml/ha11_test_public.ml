...
let () =
  add 0 @@ Test.make_simple_test ~title:"test_int_hashmap" test_int_hashmap;
  add 0 @@ Test.make_simple_test ~title:"test_int_treemap" test_int_treemap;
  add 0 @@ Test.make_simple_test ~title:"test_extended_list" test_extended_list;
  add 0 @@ Test.make_simple_test ~title:"test_extended_tree" test_extended_tree
