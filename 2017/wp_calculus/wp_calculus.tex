...
\item $0[i/j]=0$
\item $WP\llbracket x=read();\rrbracket((x+1)^2=x^2+2x+1)\equiv\forall x. (x+1)^2=x^2+2x+1$
\end{itemize}
\end{exa}
}
...
\item Oft hängt die Invariante stark mit der Aussage am ``Ausstiegspunkt'' (hier F) zusammen und beschreibt diesen in Abhängigkeit der Laufvariable (hier i).
