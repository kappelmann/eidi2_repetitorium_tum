...
\end{equation*}
Es gilt jedoch nicht $0\le x$, denn der Benutzer könnte eine negative Zahl eingeben. Nun gilt es, unsere Invariante zu verifizieren. Hierfür beginnen wir von I und laufen rückwärts einmal die ganze Schleife entlang.
\begin{align*}
...
Im vorletzten Schritt haben wir unsere Aussage verstärkt, indem wir eine Und-Klausuel hinzugefügt haben und im letzten Schritt haben wir sie verstärkt, indem wir eine Oder-Klausel entfernt haben. Jetzt sind wir fast fertig, wir müssen nur noch sequentiell zum Start zurückrechnen.
\begin{align*}
